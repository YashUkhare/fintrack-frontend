    ...
    <div class="min-h-screen bg-gradient-to-br from-primary-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 
      ...
      <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8 animate-fade-in">
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-2">Join FinTrack and start managing your finances</p>
        </div>
            ...
            <div class="mb-4">
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 
                         bg-white dark:bg-gray-700 text-gray-900 dark:text-white
                         focus:ring-2 focus:ring-primary-500 focus:border-transparent pr-12"
    ...
    onSubmit(): void {
        if (this.registerForm.valid && !this.loading) {
            ...
            this.authService.register(registerData).subscribe({
                next: () => {
                    this.toastr.success('Account created successfully!', 'Welcome to FinTrack');
